 ...
 *
 * This script is for updating ALLNet Billing
 **/
session_start();
include "config.php";
...
if (empty($update_url)) {
    $update_url = 'https://github.com/allnetbilling/allnet-billing/archive/refs/heads/master.zip';
}
...
$file = pathFixer('system/cache/allnetbilling.zip');
$folder = pathFixer('system/cache/allnetbilling-' . basename($update_url, ".zip") . '/');
...
<head>
    ...
    <title>ALLNet Billing Updater</title>
...
<body class="hold-transition skin-blue">
    <div class="container">
                    ...
                    <?php if ($continue || $step == 5) { ?>
                        ...
                        <?php } else if ($step == 5) { ?>
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ALLNet Billing has been updated to Version <b><?= $version ?></b>
                                </div>
                            </div>
        ...
        <footer class="footer text-center">
            ALLNet Billing by <a href="https://github.com/allnetbilling/allnet-billing" rel="nofollow noreferrer noopener" target="_blank">ALLNet Team</a>
        </footer>
    </div>
</body>
